...
//! default in migration 0002. See ADR-0002 for the storage Port decision.

use deve_sub_domain::IdentityError;
...
///
/// # Errors
/// Returns [`IdentityError::Storage`] if formatting fails.
pub fn format_ts(ts: Timestamp) -> Result<String, IdentityError> {
...
///
/// # Errors
/// Returns [`IdentityError::Storage`] if parsing fails.
pub fn parse_ts(s: &str) -> Result<Timestamp, IdentityError> {
