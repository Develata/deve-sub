...
# WHY: Pinned Rust version matches CI (dtolnay/rust-toolchain@1.97.1).
...
# WHY: bookworm-slim is a specific Debian release, not "latest".
...
# Healthcheck: hit the liveness endpoint. curl is the only extra runtime dep.
